...
PairStyle(body/rounded/polyhedron/agent,PairBodyRoundedPolyhedronAgent)

#else

#ifndef LMP_PAIR_BODY_ROUNDED_POLYHEDRON_AGENT_H
#define LMP_PAIR_BODY_ROUNDED_POLYHEDRON_AGENT_H

#include "pair.h"

namespace LAMMPS_NS {

class PairBodyRoundedPolyhedronAgent : public Pair {
 public:
  PairBodyRoundedPolyhedronAgent(class LAMMPS *);
  ~PairBodyRoundedPolyhedronAgent();
